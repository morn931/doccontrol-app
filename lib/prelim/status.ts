...
export type PrelimStatus = 'not_started' | 'in_review' | 'sent_drawing_office' | 'sent_lead' | 'returned' | 'ready_for_tender'
...
export const STATUS_LABEL: Record<PrelimStatus, string> = {
  ...
  returned:            'Returned from drawing office / lead',
...
export const STATUS_ORDER: PrelimStatus[] = ['not_started', 'in_review', 'sent_drawing_office', 'sent_lead', 'returned', 'ready_for_tender']
