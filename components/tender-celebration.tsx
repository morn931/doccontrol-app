 ...
 * load on SHOW_ON (Central Africa Time), and goes away on Close or after 10 s.
...
export default function TenderCelebration({ email }: { email: string }) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, pointerEvents: 'none', overflow: 'hidden' }} aria-live="polite">
      ...
      <div style={{ position: 'absolute', top: '30%', left: 0, whiteSpace: 'nowrap', animation: 'tc-run 9s linear infinite', textAlign: 'center' }}>
