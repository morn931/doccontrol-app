...
export default async function PrelimStatusPage() {
  ...
  const rows = (docs ?? []).map((d: any) => ({
    ...
    quality_open: d.quality_open, quality_checked_at: d.quality_checked_at, handed_over_batch_id: d.handed_over_batch_id,
  }))
