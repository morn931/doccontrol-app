    ...
    <div className="max-w-4xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <Link href="/developer/permissions" className={card}>
          ...
          <div>
            <h2 className="text-sm font-semibold text-slate-800 group-hover:text-teal-700 transition-colors">Role Permissions</h2>
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">Reference matrix showing which roles can access each page and action in CoreDocs.</p>
          </div>
        </Link>
